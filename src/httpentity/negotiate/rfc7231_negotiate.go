...
func NegotiateContentType(header *string, contenttypes []string) (max qvalue, quality map[string]qvalue, err error) {
...
func NegotiateCharset(header *string, charsets []string) (max qvalue, quality map[string]qvalue, err error) {
...
func NegotiateEncoding(header *string, encodings []string) (max qvalue, quality map[string]qvalue, err error) {
...
func NegotiateLanguage(header *string, languageTags []string) (max qvalue, quality map[string]qvalue, err error) {
